...
or a similar setup where each node has a manually configurable network address.

Note, strict routability for addresses is turned off in the config file.

Example:
	bpsd multi-node --v 4 --output-dir ./.testnets --validators-stake-amount 1000000,200000,300000,400000 --list-ports 47222,50434,52851,44210
	`,
	...
	cmd.Flags().String(flagStartingIPAddress, "localhost", "Starting host for generated peer addresses (e.g. localhost results in ID0@localhost:46656)")
